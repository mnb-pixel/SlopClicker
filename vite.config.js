...
// Entfernt die reinen Web-Skripte (Termly-Consent, Google AdSense) aus index.html, wenn für
// die native App gebaut wird - `npm run build:ios` setzt dafür --mode native. Gesteuert über
...
// zulässig, Termly würde parallel zum nativen UMP-Consent laufen - und beide würden auch für
// Werbefrei-Käufer:innen laden, also genau das brechen, was der IAP verspricht.
