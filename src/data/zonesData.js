...
export const ZONES_DATA = [
  {
    ...
    buildings: [
      { id: 'prompt_intern', maxProps: 160, plot: { capacity: 4, max: 40, axis: 'x', lane: 0, perRow: 5 } },
      { id: 'chatbot_widget', maxProps: 25 },
      { id: 'prompt_engineer', maxProps: 120, plot: { capacity: 4, max: 30, axis: 'x', lane: 0, perRow: 5, offset: 5 } },
    ],
  },
  {
    id: 'basement',
    ...
    buildings: [
      { id: 'gpu_rack', maxProps: 100, plot: { capacity: 4, max: 25, axis: 'x', lane: 0, perRow: 5 } },
      { id: 'datacenter', maxProps: 40, plot: { capacity: 2, max: 20, axis: 'x', lane: 2, perRow: 4 } },
      { id: 'web_scraper', maxProps: 28 },
      { id: 'token_burner', maxProps: 60, plot: { capacity: 4, max: 15, axis: 'x', lane: 1, perRow: 5 } },
      { id: 'gray_market_dc', maxProps: 24, plot: { capacity: 2, max: 12, axis: 'x', lane: 3, perRow: 4 } },
    ],
  },
  {
    id: 'stage',
    ...
    buildings: [
      { id: 'thought_leader', maxProps: 80, plot: { capacity: 4, max: 20, axis: 'x', lane: 1, perRow: 5 } },
      { id: 'hype_journalist', maxProps: 80, plot: { capacity: 4, max: 20, axis: 'x', lane: 2, perRow: 5 } },
      { id: 'keynote_stage', maxProps: 18, plot: { capacity: 1, max: 18, axis: 'x', lane: 0, perRow: 6 } },
      { id: 'pitch_deck', maxProps: 32 },
      { id: 'lobbyist', maxProps: 18, plot: { capacity: 1, max: 18, axis: 'x', lane: 3, perRow: 6 } },
    ],
  },
  {
    id: 'tower',
    ...
    labelAnchor3d: { x: 13.2, y: 0.5, z: -5.9 },
    buildings: [
      { id: 'vc_firm', maxProps: 90, plot: { capacity: 6, max: 15, axis: 'x', lane: 0, perRow: 5 } },
      { id: 'pivot_startup', maxProps: 45, plot: { capacity: 3, max: 15, axis: 'x', lane: 1, perRow: 5 } },
  ...
  },
  {
    ...
    buildings: [
      { id: 'nuclear_reactor', maxProps: 16, plot: { capacity: 1, max: 16, axis: 'x', lane: 0, perRow: 4 } },
      { id: 'metaverse_city', maxProps: 45, plot: { capacity: 3, max: 15, axis: 'x', lane: 1, perRow: 5 } },
      { id: 'excel_sheet', maxProps: 36 },
